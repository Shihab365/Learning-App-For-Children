...
public class list2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adView.setAdUnitId("ca-app-pub-1818607113375588/5708092950");

        MobileAds.initialize(this,"ca-app-pub-1818607113375588~3556756114");
        ad2=(AdView) findViewById(R.id.list2adid);
        ...
        textView=findViewById(R.id.page2id);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent ab=new Intent(list2Activity.this,AboutActivity.class);
            startActivity(ab);
            return true;
        }
